...
const Support = () => {
    return (
        <>
            ...
            <div className={"leftcenter"}>
                <a  href="https://patreon.com/Bubzia" target="_blank" rel="noreferrer"><img src={PatreonImage} width={"150"} height={"150"} /></a>
                ...
                <div className={"leftcenter"}>
                <a  href="https://www.twitch.tv/subs/bubzia" target="_blank" rel="noreferrer"><img src={TwitchImage} width={"300"} height={"150"}/></a>
